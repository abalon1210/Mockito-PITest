...
import org.mockito.main.MockitoFramework;

/**
 * Reported when instance of {@link org.mockito.listeners.MockitoListener}
 * is being added to Mockito (see {@link MockitoFramework})
 ...
 * according to the API specification - see {@link MockitoFramework#addListener(MockitoListener)}.
 *
 * @since 2.5.2
 */
